...
export function MoodSticker({ mood, className }: { mood: Mood; className?: string }) {
  ...
  return (
    <svg className={className} viewBox="0 0 136 112" fill="none" aria-hidden="true">
      {mood === "happy" && <>
        <path d="M64 34C51 14 20 20 19 46C18 68 40 89 59 99Q64 102 69 99C88 89 110 68 109 46C108 20 77 14 64 34Z" fill={color} />
      ...
      {mood === "relaxed" && <>
        <path d="M66 15C88 12 105 28 109 49C113 72 99 90 78 97C57 104 27 98 19 82C10 63 21 42 37 29C47 21 56 16 66 15Z" fill={color} />
        <g stroke="#25272b" strokeWidth="5.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      {mood === "tired" && <>
        <path d="M55 22C59 15 69 15 74 23L109 82C115 93 109 101 97 101H31C19 101 13 93 19 82Z" fill={color} />
        <g stroke="#25272b" strokeWidth="5.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      {mood === "sad" && <>
        <path d="M30 17L96 20Q110 21 109 35L106 86Q105 100 91 100L28 97Q15 96 16 83L18 31Q19 17 30 17Z" fill={color} />
        <g fill="#25272b">
