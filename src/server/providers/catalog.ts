...
export const MOCK_CATALOG: CatalogSpot[] = [
  ...
  {
    id: "mock:yakiniku-marunouchi",
    name: "丸の内焼肉モック",
    lat: 35.6808,
    lng: 139.7655,
    categories: ["steak_house", "barbecue_restaurant", "restaurant"],
    types: ["steak_house", "barbecue_restaurant", "restaurant"],
    environment: { value: "INDOOR", evidenceIds: ["ev-yaki-env"] },
    costForTwoJpy: { value: { min: 8000, max: 12000 }, evidenceIds: ["ev-yaki-cost"] },
    restEase: { value: "EASY", evidenceIds: ["ev-yaki-rest"] },
    standingBurden: { value: "LOW", evidenceIds: ["ev-yaki-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "11:00", close: "22:00" }],
    walkRestHint: "焼肉・ステーキ系のモック店",
  },
  {
    id: "mock:sushi-marunouchi",
    name: "丸の内寿司モック",
    lat: 35.6811,
    lng: 139.7662,
    categories: ["sushi_restaurant", "restaurant"],
    types: ["sushi_restaurant", "restaurant"],
    environment: { value: "INDOOR", evidenceIds: ["ev-sushi-env"] },
    costForTwoJpy: { value: { min: 7000, max: 11000 }, evidenceIds: ["ev-sushi-cost"] },
    restEase: { value: "EASY", evidenceIds: ["ev-sushi-rest"] },
    standingBurden: { value: "LOW", evidenceIds: ["ev-sushi-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "11:30", close: "21:30" }],
    walkRestHint: "寿司のモック店",
  },
  {
    id: "mock:italian-marunouchi",
    name: "丸の内イタリアンモック",
    lat: 35.6804,
    lng: 139.765,
    categories: ["italian_restaurant", "pizza_restaurant", "restaurant"],
    types: ["italian_restaurant", "pizza_restaurant", "restaurant"],
    environment: { value: "INDOOR", evidenceIds: ["ev-ita-env"] },
    costForTwoJpy: { value: { min: 6000, max: 10000 }, evidenceIds: ["ev-ita-cost"] },
    restEase: { value: "EASY", evidenceIds: ["ev-ita-rest"] },
    standingBurden: { value: "LOW", evidenceIds: ["ev-ita-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "11:00", close: "22:00" }],
    walkRestHint: "イタリアンのモック店",
  },
  {
    id: "mock:street-food-yaesu",
    name: "八重洲食べ歩きモック",
    lat: 35.6802,
    lng: 139.7688,
    categories: ["meal_takeaway", "market"],
    types: ["meal_takeaway", "market"],
    environment: { value: "INDOOR", evidenceIds: ["ev-street-env"] },
    costForTwoJpy: { value: { min: 2000, max: 4000 }, evidenceIds: ["ev-street-cost"] },
    restEase: { value: "LIMITED", evidenceIds: ["ev-street-rest"] },
    standingBurden: { value: "MEDIUM", evidenceIds: ["ev-street-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "10:00", close: "21:00" }],
    walkRestHint: "食べ歩き向けのモック",
  },
  {
    id: "mock:market-only-yaesu",
    name: "八重洲市場モック（非食品）",
    lat: 35.6803,
    lng: 139.769,
    categories: ["market"],
    types: ["market"],
    environment: { value: "INDOOR", evidenceIds: ["ev-mkt-env"] },
    costForTwoJpy: { value: { min: 0, max: 0 }, evidenceIds: ["ev-mkt-cost"] },
    restEase: { value: "LIMITED", evidenceIds: ["ev-mkt-rest"] },
    standingBurden: { value: "MEDIUM", evidenceIds: ["ev-mkt-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "10:00", close: "20:00" }],
    walkRestHint: "market type のみ。食べ歩き達成には使えない",
  },
  {
    id: "mock:odaiba-beach",
    name: "お台場ビーチモック",
    lat: 35.6295,
    lng: 139.7755,
    categories: ["beach"],
    types: ["beach"],
    environment: { value: "OUTDOOR", evidenceIds: ["ev-beach-env"] },
    costForTwoJpy: { value: { min: 0, max: 0 }, evidenceIds: ["ev-beach-cost"] },
    restEase: { value: "LIMITED", evidenceIds: ["ev-beach-rest"] },
    standingBurden: { value: "MEDIUM", evidenceIds: ["ev-beach-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "00:00", close: "24:00" }],
    walkRestHint: "海を眺める用のモック",
  },
  {
    id: "mock:aquarium-tokyo",
    name: "東京水族館モック",
    lat: 35.634,
    lng: 139.732,
    categories: ["aquarium"],
    types: ["aquarium"],
    environment: { value: "INDOOR", evidenceIds: ["ev-aqua-env"] },
    costForTwoJpy: { value: { min: 4000, max: 6000 }, evidenceIds: ["ev-aqua-cost"] },
    restEase: { value: "LIMITED", evidenceIds: ["ev-aqua-rest"] },
    standingBurden: { value: "HIGH", evidenceIds: ["ev-aqua-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "10:00", close: "20:00" }],
    walkRestHint: "水族館モック",
  },
  {
    id: "mock:cinema-yurakucho",
    name: "有楽町シネマモック",
    lat: 35.6748,
    lng: 139.761,
    categories: ["movie_theater"],
    types: ["movie_theater"],
    environment: { value: "INDOOR", evidenceIds: ["ev-cine-env"] },
    costForTwoJpy: { value: { min: 3600, max: 4000 }, evidenceIds: ["ev-cine-cost"] },
    restEase: { value: "EASY", evidenceIds: ["ev-cine-rest"] },
    standingBurden: { value: "LOW", evidenceIds: ["ev-cine-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "10:00", close: "23:00" }],
    walkRestHint: "映画館モック",
  },
  {
    id: "mock:zoo-ueno",
    ...
    categories: ["zoo"],
    types: ["zoo"],
    environment: { value: "OUTDOOR", evidenceIds: ["ev-zoo-env"] },
    costForTwoJpy: { value: { min: 1200, max: 1200 }, evidenceIds: ["ev-zoo-cost"] },
    restEase: { value: "LIMITED", evidenceIds: ["ev-zoo-rest"] },
    standingBurden: { value: "HIGH", evidenceIds: ["ev-zoo-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "09:30", close: "17:00" }],
    walkRestHint: "動物園モック",
  },
  {
    id: "mock:amusement-odaiba",
    name: "お台場遊園地モック",
    lat: 35.6267,
    lng: 139.7765,
    categories: ["amusement_park"],
    types: ["amusement_park"],
    environment: { value: "OUTDOOR", evidenceIds: ["ev-amus-env"] },
    costForTwoJpy: { value: { min: 8000, max: 12000 }, evidenceIds: ["ev-amus-cost"] },
    restEase: { value: "LIMITED", evidenceIds: ["ev-amus-rest"] },
    standingBurden: { value: "HIGH", evidenceIds: ["ev-amus-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "10:00", close: "21:00" }],
    walkRestHint: "遊園地モック",
  },
  ...
  },
  {
    ...
    environment: { value: "INDOOR", evidenceIds: ["ev-demo-tomoshibi-env"] },
    costForTwoJpy: { value: { min: 0, max: 0 }, evidenceIds: ["ev-demo-tomoshibi-cost"] },
    restEase: { value: "EASY", evidenceIds: ["ev-demo-tomoshibi-rest"] },
    standingBurden: { value: "MEDIUM", evidenceIds: ["ev-demo-tomoshibi-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "09:00", close: "22:00" }],
    walkRestHint: "大会デモ用の固定会場（神田駿河台）",
  },
  {
    ...
    lat: 35.6991,
    lng: 139.7634,
    categories: ["japanese_restaurant", "bar", "restaurant"],
    types: ["japanese_restaurant", "bar", "restaurant"],
    environment: { value: "INDOOR", evidenceIds: ["ev-suru-iza-env"] },
    costForTwoJpy: { value: { min: 6000, max: 10000 }, evidenceIds: ["ev-suru-iza-cost"] },
    restEase: { value: "EASY", evidenceIds: ["ev-suru-iza-rest"] },
    standingBurden: { value: "LOW", evidenceIds: ["ev-suru-iza-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "16:00", close: "23:30" }],
    walkRestHint: "AI HACK 後の飲み用モック居酒屋",
  },
  {
    id: "mock:ochanomizu-bar",
    name: "御茶ノ水モックバー",
    lat: 35.6998,
    lng: 139.7652,
    categories: ["bar", "restaurant"],
    types: ["bar", "restaurant"],
    environment: { value: "INDOOR", evidenceIds: ["ev-ocha-bar-env"] },
    costForTwoJpy: { value: { min: 5000, max: 9000 }, evidenceIds: ["ev-ocha-bar-cost"] },
    restEase: { value: "EASY", evidenceIds: ["ev-ocha-bar-rest"] },
    standingBurden: { value: "LOW", evidenceIds: ["ev-ocha-bar-stand"] },
    officialUrl: null,
    hours: [{ days: [0, 1, 2, 3, 4, 5, 6], open: "17:00", close: "24:00" }],
    walkRestHint: "御茶ノ水寄りのモックバー",
  },
];
